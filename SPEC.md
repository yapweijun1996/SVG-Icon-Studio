...
**Current release:** `v0.9.17` (2026-09-12) — see [CHANGELOG.md](CHANGELOG.md) for the full version history and [ROADMAP.md](ROADMAP.md) / [TASK.md](TASK.md) for what's planned next.
...
## 0. Current status snapshot (v0.9.17, 2026-09-12)
