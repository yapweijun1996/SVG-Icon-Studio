...
**Releases:** `v0.6.1` → `v0.7.24` (2026-07-31 → 2026-09-11)
...
**Status:** Complete for the current scope through `v0.7.24`; see each release's Validation section in `CHANGELOG.md` for browser and automated evidence.
